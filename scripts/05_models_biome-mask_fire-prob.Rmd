...
pred_vars_mat <- pred_vars
 # needs to have no spaces for parsing in function to work
pred_vars_mat <- self_name(pred_vars_mat)
...
```{r}
var_transformed <- map_chr(mods_glm_mtbs2, function(x) x$var_transformed)
var_transformed
```
