...
```{r gnm_iterate_transform,message=FALSE, cache=TRUE}
...
"mtbs_prop ~ afgNonLin(afgAGB) + poly(pfgAGB,2) + shrCover + MAT + poly(MAP,2) + prcpPropSum"
...
```{r fit_gnm1, dependson='gnm_iterate_transform', cache=TRUE,message=FALSE}
...
saveRDS(mods2save, "models/glm_binomial_models_v1.RDS")

mods2save_gnm <- mod_gnm1_flat
mods2save_gnm$formula <- best_form_gnm1
saveRDS(mods2save_gnm, "models/gnm_binomial_models_v1.RDS")
```
