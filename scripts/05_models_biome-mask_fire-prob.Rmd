...
saveRDS(mods2save, "models/glm_binomial_models_v3_afgAGB-MAP-interaction.RDS")

mods2save_gnm <- mod_gnm1_flat
mods2save_gnm$formula <- best_form_gnm1
saveRDS(mods2save_gnm, "models/gnm_binomial_models_v3_afgAGB-MAP-interaction.RDS")
