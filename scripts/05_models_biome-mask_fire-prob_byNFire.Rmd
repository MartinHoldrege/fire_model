...
output:
  html_document:
    ...
    toc_float:
      collapsed: false
---
This version of the model includes interactions between MAT and summer ppt,
annuals and MAT, and annuals and perennials.
...
test_run <- FALSE
s <- "_S-T_A-T_A-Pr" # string to paste to file names (summer ppt * MAT) and annuals*temperature interactions
```
...
g2 <- g +
  inset_element(inset, left = 0.7, bottom = -0.15,
                right = 1, top = 0.4)
g2
jpeg(paste0("figures/quantile_plots/quantile_plot_v3", s,  ".jpeg"), 
     units = "in", res = 600, width = 5, height = 3.5 )
g2
dev.off()
```
...
jpeg(paste0("figures/quantile_plots/quantile_plot_filtered_insets_v1", 
            s, ".jpeg"), units = "in", res = 600, width = 7, height = 8 )
g2
dev.off()
