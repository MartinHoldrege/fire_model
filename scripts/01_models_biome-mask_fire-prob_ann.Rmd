...
hmod <- params$hmod # whether to include human modification in the model (main model did not include hmod, but model in appendix did)
...
preserves the correct total area burned, and also should reduce noise
