...
g
jpeg("figures/quantile_plots/quantile_plot_hmod_v1.jpeg", units = "in", res = 600,
     width = 5, height = 3.5 )
g 
dev.off()
```
...
jpeg("figures/quantile_plots/quantile_plot_filtered_hmod_v1.jpeg", units = "in", res = 600,
     width = 5.5, height = 6 )
g 
dev.off()
```
...
saveRDS(mods2save, 
        paste0("models/glm_binomial_models_byNFire_hmod_v1_bin",
